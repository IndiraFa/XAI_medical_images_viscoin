"""
Script to train a VisCoIn model on the CUB dataset resized to 256x256,
...
# Constants
CLASSIFIER_PATH = "/home/ids/fabre-24/viscoin/VisCoIN/checkpoints/trained_classif_CUB/cub_classifier.pth"
GAN_PATH = "/home/ids/fabre-24/viscoin/VisCoIN/stylegan2_ada/training-runs-CUB/00006-resized_images_256_for_gan_2-auto1-kimg1000-resumecustom/network-snapshot-001000.pkl"
ADAPTED_GAN_PATH = "/home/ids/fabre-24/viscoin/VisCoIN/checkpoints/adapted_gan_nct_crc_he_256/gan_adapted256.pth"
IMAGE_SIZE = (256, 256)
...
def main():
    ...
    try:
        ...
        n_classes = N_CLASSES  # Determine the number of output classes
        ...
        train_viscoin_custom(batch_size=BATCH_SIZE, n_epochs=EPOCH, alpha=ALPHA, beta=BETA, gamma=GAMMA, delta=DELTA, classifier=classifier, concept_extractor=concept_extractor, explainer=explainer, viscoin_gan=viscoin_gan, generator_gan=generator_gan, train_loader=train_loader, test_loader=test_loader, device=device)
